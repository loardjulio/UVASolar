    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" href="#simulacao">Simulação</a>
                        </li>
                        <li class="nav-item">
        ...
        <header class="masthead">
            <div class="container">
                <div class="intro-text">
                    ...
                    <div class="intro-heading text-uppercase">Energia fotovotaica</div>
        ...
        <section class="bg-light" id="portfolio">
                      ...
                      <div class="row">
                        <div class="col-lg-12 text-center">
                          <h2 class="section-heading text-uppercase">Energia Solar forever</h2>
                          <h3 class="text-muted">Tenha em sua casa uma geração de energia  renovável e inesgotável.</h3>
                        </div>
                      </div>
                        <br>
                      ...
                      <div class="row">
                        <div class="col-md-4 col-sm-6 portfolio-item">
                          ...
                          <div class="portfolio-caption">
                            <h4>Ecológico</h4>
                            <p class="text-muted">A energia solar não polui durante seu uso.  Ao contrário dos combustíveis fósseis, o processo de geração de energia elétrica a partir da energia solar não emite dióxido de enxofre (SO2), óxidos de nitrogênio (NOx) e dióxido de carbono (CO2) - todos gases poluentes com efeitos nocivos à saúde humana e que contribuem para o aquecimento global.</p>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 portfolio-item">
                          ...
                          <div class="portfolio-caption">
                            <h4>O Melhor sol do mundo!</h4>
                            <p class="text-muted">Em países tropicais, como o Brasil, a utilização da energia solar é viável em praticamente todo o território nacional.</p>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 portfolio-item">
                          ...
                          <div class="portfolio-caption">
                            <h4>Pouca manutenção!</h4>
                            <p class="text-muted">As centrais necessitam de manutenção mínima.</p>
                          </div>
        ...
        <section id="etapas">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="section-heading text-uppercase">Passo a passo</h2><br>
        ...
        <section class="bg-light" id="simulacao">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <h2 class="section-heading text-uppercase">Faça sua simulação</h2>
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col">
                            <input type="number" class="form-control" placeholder="Consumo médio mensal (kWh):">
                        </div>

                        <div class="col">
                            <input type="number" class="form-control" placeholder="Info">
                        </div>

                        <div class="col">
                            <input type="number" class="form-control" placeholder="custo">
                        </div>
                    </div> <br>
                    <div class="row">
                    ...
                    <button type="submit" class="btn btn-primary">Simular agora</button>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input class="form-control" id="name" type="text" placeholder="Seu nome*" required="required" data-validation-required-message="Ops! Insira seu nome.">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" id="email" type="email" placeholder="Seu melhor Email *" required="required" data-validation-required-message="Ops! Insira seu email">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="form-group">
        ...
        <footer class="site-footer">
            <div  class="container">
                <div class="row">
                    <div class="col-md-4">
                        <span class="copyright">Copyright &copy; UVA energia 2019</span>
                    </div>
                    <div class="col-md-4">
